...
import "./entrar-sidebar.css"
export const EntrarSidebar = () => {
    return (
        <Link to='/login'>
        <button className="entrar-sidebar-button">
            <svg className="entrar-sidebar-icon" viewBox="0 0 8.4666669 8.4666669">
            ...
            <span className="entrar-sidebar-span">Entrar</span>
        </button>
        </Link>
    )
}